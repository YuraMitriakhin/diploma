...
<div class="container">
 ...
 <li role="presentation" class="active"><a href="/login" ><@s.message "login.form.name"/></a></li>
 <li role="presentation"><a href="/registration"><@s.message "register.form.name"/></a></li>
 </ul>
 <!-- Tab panes -->
 ...
 <input type="password" required class="form-control" id="password" name="password">
  ...
  <#if logout>
   <p><font size="3" color="red" face="Arial"><@s.message "login.logout"/></font></p>
  </#if>
  <#if error>
   <p><font size="3" color="red" face="Arial"><@s.message "login.error"/></font></p>
  </#if>
 <div class="form-group">
 <button type="submit" class="btn btn-default"><@s.message "login.button"/></button>
 </div>
 <div class="form-group forgot-pass">
 <button type="submit" class="btn btn-default"><@s.message "login.forgot.password"/></button>
 </div>
 </form>
 </div>
